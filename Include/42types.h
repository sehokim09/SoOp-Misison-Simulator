...
struct BodyType {
   ...
   double J[3][3]; /* Moment of Inertia, about ref pt, expressed in B frame */
...
struct SCType {
   ...
   // I -> J for complex number
   double J[3][3]; /* Inertia matrix, wrt SC.cm, expressed in B0 frame */
   ...
   /* The following are for SoOp */
   double PosW[3]; // Position of cm in ECEF frame
   double VelW[3]; // Velocity of cm in ECEF frame
   double PosRxAntN[3]; // Position of receiving antenna (antenna body's ref pt) in ECI frame
   double PosRxAntW[3]; // Position of receiving antenna (antenna body's ref pt) in ECEF frame
   double VelRxAntN[3]; // Velocity of receiving antenna (antenna body's ref pt) in ECI frame
   double VelRxAntW[3]; // Velocity of receiving antenna (antenna body's ref pt) in ECEF frame
   uint32_t Ncycle; // The number of orbit cycle
